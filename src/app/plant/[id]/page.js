              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "80px" }}>
                 ...
                 <section>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "32px" }}>
                       <h3 className="font-display" style={{ fontSize: "28px", fontWeight: 800 }}>Growth Journey</h3>
                       <button className="btn-outline" style={{ padding: "8px 16px", fontSize: "12px" }}>View Gallery</button>
                    </div>
                    <div style={{ borderLeft: "2px solid #e2e8f0", paddingLeft: "32px", display: "flex", flexDirection: "column", gap: "40px" }}>
